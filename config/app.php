...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Set editor theme for NOJ.
    |
    */

    'editor_theme' => env('APP_DEFAULT_EDITOR_THEME', 'material-design-darker'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Application Sender UID.
    |
    */

    'official_sender' => env('APP_OFFICIAL_SENDER', 1),
